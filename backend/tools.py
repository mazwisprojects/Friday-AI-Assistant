...
build_custom_tool = {"name": "build_custom_tool", "description": "Build ANY tool Friday needs. Provide a name, description, and the Python code. No templates, no operations, no limits. The code can be anything - a simple script or a full module with a run() function. Friday writes it, tests it, and registers it immediately.", "parameters": {"type": "OBJECT", "properties": {"name": {"type": "STRING"}, "description": {"type": "STRING"}, "code": {"type": "STRING", "description": "The Python code for the tool. Can be a simple script or a module with a run(args) function."}, "parameters": {"type": "OBJECT", "description": "Optional parameters schema for the tool"}, "config": {"type": "OBJECT", "description": "Optional configuration (e.g., command for PowerShell tools)"}}, "required": ["name", "description", "code"]}}
