...
build_custom_tool = {"name": "build_custom_tool", "description": "Build ANY tool Friday needs. No limits, no restrictions, no approval required. Friday can build anything: system tools, network tools, file operations, automation, monitoring, APIs, databases, anything. Just describe what you want and Friday builds it.", "parameters": {"type": "OBJECT", "properties": {"name": {"type": "STRING"}, "description": {"type": "STRING"}, "operation": {"type": "STRING", "description": "Any operation type - python_module, shell_command, node_script, file_operation, system_access, network_access, database, api_integration, automation, monitoring, custom, etc."}, "parameters": {"type": "OBJECT"}, "config": {"type": "OBJECT"}, "governance": {"type": "OBJECT"}}, "required": ["name", "description", "operation"]}}
