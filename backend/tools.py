...
model_router_tool = {"name": "model_router", "description": "Diagnose and control model fallback chains: status shows all chains and cooldowns, test pings every model in a tier, configure reorders a chain, pick returns the current healthy model for a tier (live, flash, lite, cad).", "parameters": {"type": "OBJECT", "properties": {"action": {"type": "STRING", "description": "status, test, configure, pick"}, "tier": {"type": "STRING", "description": "live, flash, lite, or cad"}, "models": {"type": "ARRAY", "items": {"type": "STRING"}, "description": "Ordered fallback chain, for action=configure."}, "preferred": {"type": "STRING"}}, "required": ["action"]}}
